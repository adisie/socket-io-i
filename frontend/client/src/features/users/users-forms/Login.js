    ...
    <div className="pt-7">
      <form className="px-7 py-3 text-xs font-serif text-gray-700 bg-black bg-opacity-[.15] rounded-sm flex flex-col">
        ...
        <div className='mb-2'>
          ...
          <div className='text-center text-[.7rem]' id='login-username-error'>{errors?.username}</div>
        </div>
        {/* password */}
        <div className='mb-2'>
          <div className='bg-white px-3 rounded-sm py-[.25rem] flex items-center'>
          ...
          <div className='text-center text-[.7rem]' id='login-password-error'>{errors?.password}</div>
        </div>
